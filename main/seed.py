...
exval = [
    ...
    (6,'Forsta','QA Engineer','07/2022 - 01/2024','Tested new and old programs to ensure functionality, and desired effect. Coordinated with developers to ensure that new programs did not interfere with existing architecture, and worked as expected. Deployed new code on a bi-weekly basis into production. Worked with automated testing libraries such as Cypress to create automated tests for the user interface of our product. Interned to become a software developer by picking up increasingly difficult bug and feature cards with supervision.'),
    (7,'Forsta','Software Engineer II','01/2024 - Present','Develop new applications and maintain existing applications for a large legacy codebase used in the survey application Decipher. Technologies used include Python, various Javascript libraries and frameworks including React, Vue and AngularJS as well as AWS.' )
]
